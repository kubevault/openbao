...
func TestSystemBackend_PluginCatalog_List(t *testing.T) {
	...
	t.Run("typed", func(t *testing.T) {
		...
		if diff := deep.Equal(resp.Data, map[string]any{
			"keys": []string{
				"cassandra-database-plugin", "druid-database-plugin", "elasticsearch-database-plugin", "hana-database-plugin", "ignite-database-plugin", "influxdb-database-plugin", "milvus-database-plugin", "mongodb-database-plugin", "mssql-database-plugin", "mysql-aurora-database-plugin",
				...
				"remote-cassandra-plugin", "remote-druid-plugin", "remote-elasticsearch-plugin", "remote-hana-plugin", "remote-ignite-plugin", "remote-influxdb-plugin", "remote-milvus-plugin", "remote-mongodb-plugin", "remote-mssql-plugin", "remote-mysql-plugin",
